...
| Поле                 | Тип       | Назначение                                                                 |
| -------------------- | --------- | -------------------------------------------------------------------------- |
| `ID`                 | uint      | Уникальный идентификатор переменной в системе                              |
...
| `ProjectID`          | \*uint    | Ссылка на проект (nil для глобальных переменных)                           |
...
| **Проекта**    | `uint` (ID проекта)  | Доступна только проекту с указанным идентификатором |
