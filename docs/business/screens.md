...
| Сущность     | Использование                                                                                      |
| ------------ | -------------------------------------------------------------------------------------------------- |
| `Project`    | Полная информация: `id`, `name`, `created_at`, `dir`, `git_url`, `git_branch`, `stages`            |
...
| Сущность            | Использование                                                                                                                       |
| ------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| `ProjectRun`        | Полная информация о запуске: `id`, `created_at`, `project_id`, `success`, `pending`, `processing`, `fail_log`, `stages`, `git_logs` |
...
| `ProjectRunGitLogs` | Git-коммиты: `number`, `hash`, `subject`                                                                                            |
...
| Детали запуска   | `/projects/:project_id/runs/:run_id`     | `ProjectRun`, `ProjectRunStage`, `ProjectRunGitLogs`, `Project` | Назад к проекту                                |
